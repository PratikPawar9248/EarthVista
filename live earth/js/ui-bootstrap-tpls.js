...
.controller('UibDatepickerPopupController', ['$scope','$mdDialog', '$element', '$attrs', '$compile', '$log', '$parse', '$window', '$document', '$rootScope', '$uibPosition', 'dateFilter', 'uibDateParser', 'uibDatepickerPopupConfig', '$timeout', 'uibDatepickerConfig', 'uibDatepickerPopupAttributeWarning',
  function($scope, $mdDialog, $element, $attrs, $compile, $log, $parse, $window, $document, $rootScope, $position, dateFilter, dateParser, datepickerPopupConfig, $timeout, datepickerConfig, datepickerPopupAttributeWarning) {
    var cache = {},
    ...
    $scope.dateSelection = function(dt) {
      ...
      if (closeOnDateSelection) {
        $scope.isOpen = false;
        $element[0].focus();
        //console.log("dt if null:- ",dt);
        
        $mdDialog.hide();	//Updated and Added By Jay On 23DEC2019
