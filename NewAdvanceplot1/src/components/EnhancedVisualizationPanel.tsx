...
import { 
  ...
  Satellite, Clock, BarChart2, ScatterChart, Sparkles
} from 'lucide-react';
...
import GeospatialVisualization from './GeospatialVisualization';
import InteractiveVisualization from './InteractiveVisualization';
import DataDrivenVisualization from './DataDrivenVisualization';
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeView} onValueChange={setActiveView} className="w-full">
        <TabsList className="grid w-full grid-cols-7 bg-secondary/50">
          ...
          <TabsTrigger value="geospatial" className="flex items-center space-x-2">
        ...
        <TabsContent value="innovations" className="mt-6">
          <DataDrivenVisualization 
            data={filteredData} 
            onLocationSelect={onLocationSelect}
          />
        </TabsContent>
